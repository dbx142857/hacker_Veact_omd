  ...
  template: APP.listMixin.html`
    ...
    <t $="table-before">
      <div style="display:flex;width:100%">
        <el-form ref="tableData" style="flex:1;" :inline="true" label-position="left">
    ...
    <t $="table" :data="tableData">
      <el-table-column prop="" label="订单号" width="110">
      </el-table-column>
      <el-table-column prop="" label="卡券名称" width="130">
      </el-table-column>
      <el-table-column prop="" label="状态" width="80">
      </el-table-column>
      <el-table-column prop="" label="核销码" width="100">
      </el-table-column>
      <el-table-column prop="" label="使用/核销时间" width="130">
      </el-table-column>
      <el-table-column prop="" label="关联订单号" width="130">
      </el-table-column>
      <el-table-column prop="" label="核销人" width="110">
      </el-table-column>
      <el-table-column prop="" label="核销门店" width="110">
      </el-table-column>
      <el-table-column prop="" label="核销门店区域" width="110">
      </el-table-column>
    </t>
