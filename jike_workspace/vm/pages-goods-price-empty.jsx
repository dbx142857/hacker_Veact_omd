    ...
    <t $="table-before">
      ...
      <el-table :data="repertoryInfo" align="center"  stripe style="width: 100%">
        ...
        <el-table-column prop="code" label="规格编码" width="180">
          <t $$="scope">
            <div>
              <el-input v-model="repertoryInfo.code"
        ...
        <el-table-column prop="listpricing" label="总凭证">
    
        </el-table-column>
        <el-table-column prop="listpricing" label="可用凭证"></el-table-column>
        ...
        <el-table-column prop="operation" label="操作">
          <t $$="scope">
            <div>
              <el-button style="color:#409Eff;border-right:1px solid #409Eff">导入</el-button>
              <el-button style="color:#409Eff;border:1px solid #409Eff">历史导入</el-button>
            </div>
          </t>
        </el-table-column>
      </el-table>
